...
import { FileText, Save, RefreshCw, ImagePlus, Trash2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 text-sm text-blue-200 leading-7">
        این مشخصات روی پیش‌نمایش و PDF فاکتور خرید/فروش نمایش داده می‌شود. اگر فیلدی خالی
        بماند، از نام برند پیش‌فرض استقرار استفاده می‌شود.
      </div>
