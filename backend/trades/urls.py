...
urlpatterns = [
    ...
    path('admin/trades/manual/', views.admin_manual_trades, name='admin-manual-trades'),
    path('admin/trades/manual/<int:trade_id>/settlement/', views.admin_update_manual_settlement, name='admin-manual-settlement'),
    path('admin/customers/search/', views.admin_search_customers, name='admin-customers-search'),
    path('admin/customers/ensure/', views.admin_ensure_manual_customer, name='admin-customers-ensure'),
