...
urlpatterns = [
    ...
    path('admin/treasury/pnl/', views.admin_treasury_pnl, name='admin-treasury-pnl'),
    path('admin/treasury/export/', views.admin_treasury_export, name='admin-treasury-export'),
