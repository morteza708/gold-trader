...
urlpatterns = [
    ...
    path('admin/wallet/withdrawals/<int:request_id>/invoice/', views.admin_gold_withdrawal_invoice, name='admin-gold-withdrawal-invoice'),
    path('wallet/withdrawals/<int:request_id>/invoice/', views.user_gold_withdrawal_invoice, name='user-gold-withdrawal-invoice'),
